...
type Domain struct {
	...
	// +kubebuilder:default={conditions: {{type: "Verified", status: "Unknown", reason:"Pending", message:"Waiting for controller", lastTransitionTime: "1970-01-01T00:00:00Z"}}}
...
const (
	// This condition is true when Domain ownership has been verified via DNS.
...
const (
	...
	// was not found
	DomainReasonVerificationRecordNotFound = "VerificationRecordNotFound"

	// DomainReasonVerificationInternalError indicates that an internal error
	// was encountered during verification.
	DomainReasonVerificationInternalError = "VerificationInternalError"

...
func (in *AWSLocationProvider) DeepCopyInto(out *AWSLocationProvider) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AWSLocationProvider.
func (in *AWSLocationProvider) DeepCopy() *AWSLocationProvider {
	if in == nil {
		return nil
	}
	out := new(AWSLocationProvider)
	in.DeepCopyInto(out)
	return out
}

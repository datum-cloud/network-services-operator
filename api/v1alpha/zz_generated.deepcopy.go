...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OSWASPRuleExclusions) DeepCopyInto(out *OSWASPRuleExclusions) {
	*out = *in
	if in.Tags != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OSWASPRuleExclusions.
func (in *OSWASPRuleExclusions) DeepCopy() *OSWASPRuleExclusions {
	if in == nil {
		return nil
	}
	out := new(OSWASPRuleExclusions)
	in.DeepCopyInto(out)
	return out
}

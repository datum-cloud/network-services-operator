...
func (in *HTTPProxyRule) DeepCopyInto(out *HTTPProxyRule) {
	*out = *in
	...
	if in.Backends != nil {
		...
		*out = make([]HTTPRouteBackend, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPRouteBackend) DeepCopyInto(out *HTTPRouteBackend) {
	*out = *in
	if in.Filters != nil {
		in, out := &in.Filters, &out.Filters
		*out = make([]apisv1.HTTPRouteFilter, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPRouteBackend.
func (in *HTTPRouteBackend) DeepCopy() *HTTPRouteBackend {
	if in == nil {
		return nil
	}
	out := new(HTTPRouteBackend)
	in.DeepCopyInto(out)
	return out
}

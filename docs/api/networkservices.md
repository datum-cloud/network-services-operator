...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#networkservicespecnetworkinterfaceclaims">networkInterfaceClaims</a></b></td>
        <td>object</td>
        <td>
...
### NetworkService.spec.networkInterfaceClaims
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#networkservicespecnetworkinterfaceclaimsselector">selector</a></b></td>
        <td>object</td>
        <td>
...
### NetworkService.spec.networkInterfaceClaims.selector
<sup><sup>[↩ Parent](#networkservicespecnetworkinterfaceclaims)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#networkservicespecnetworkinterfaceclaimsselectormatchexpressionsindex">matchExpressions</a></b></td>
        <td>[]object</td>
        <td>
...
### NetworkService.spec.networkInterfaceClaims.selector.matchExpressions[index]
<sup><sup>[↩ Parent](#networkservicespecnetworkinterfaceclaimsselector)</sup></sup>
...
networking.datumapis.com/location label on the claims.<br/>
        </td>
        <td>true</td>
      </tr><tr>
        <td><b>healthy</b></td>
...
requests are failing.<br/>
        ...
        <td>integer</td>
        <td>
          members is how many claims in this location are members of the service.<br/>
          <br/>
            <i>Format</i>: int32<br/>
        </td>
        <td>false</td>
